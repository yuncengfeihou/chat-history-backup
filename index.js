                    ...
                    if (backup) {
                        if (confirm(`确定要恢复 "${backup.entityName} - ${backup.chatName}" 的备份吗？\n\n这将选中对应的角色/群组，并创建一个【新的聊天】来载入备份内容。\n当前聊天内容不会丢失，但请确保已保存。`)) {
                            ...
                            if (success) {
                                ...
                                // restoreBackup 内部应该已经显示了错误 toastr
                            }
                        }
                    } else {
